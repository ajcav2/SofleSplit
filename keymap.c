 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,        XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                 KC_LBRC, KC_LALT, KC_LGUI,  KC_LOWER, KC_SPC,           KC_ENT, KC_MINUS,KC_GRV,  KC_EQUAL, KC_RBRC\
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_HOME, _______,  _______, _______,  KC_PASTE, _______,   KC_RBRC, XXXXXXX,  KC_1,  KC_2,  KC_3, _______, _______,  KC_END, \
                    _______, _______, _______, _______,     KC_CAD,  KC_0  ,  KC_F5, KC_F10, KC_F11, _______ \
),
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
