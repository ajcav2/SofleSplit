 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  SFT_T(KC_HOME), KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,        XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  RSFT_T(KC_END), \
                 KC_LBRC, KC_LALT, KC_LGUI,  KC_DEL, LT(_LOWER, KC_SPC), LT(_MOUSE, KC_ENT), KC_MINUS,KC_GRV,  KC_EQUAL, KC_RBRC\
),
...
//         0xe0, 0x1e, 0x01, 0x00, 0x03, 0x0c, 0x30, 0xc0, 0x00, 0xf9, 0x07, 0x80, 0x78, 0uint16_t wpm_graph_timer = 0;x00, 0x00, 0x00,
